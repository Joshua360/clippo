...
app.get('/suggestions', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield db_1.default.collection('searchstatistics').insertOne({ searchInput: search });
...
app.get('/watch', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { videoDetails: { title, videoId, uploadDate, likes, category, author }, } = result;
        const videoInfo = {
            title,
            videoId,
            uploadDate,
        ...
        yield db_1.default.collection('downloadstatistics').insertOne(videoInfo);
